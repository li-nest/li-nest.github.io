...
$lang['skip_index']	        =	'Espacios de nombres a ignorar. Se debe declarar el path completo como un path del sistema de archivos. Usa el formato de las expresiones regulares. Ejemplo: /(sidebar|private\/dir)/';
$lang['skip_file']		=	'Archivos a ignorar. Las páginas deben tener la extensión .txt. Se debe declarar el path completo como un path del sistema de archivos. Usa el formato de las expresiones regulares. Ejemplo: /(start|mydir\/start.txt)/';
