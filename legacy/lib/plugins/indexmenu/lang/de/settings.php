...
$lang['skip_index']	        =	'Namespaces die nicht aufgenommen werden sollen. Es muss der komplette Pfad aus dem Dateisystem angegeben werden. Sie m&uuml;ssen Regular Ausdr&uuml;cke verweden. Beispiel: /(sidebar|private\/dir)/';
$lang['skip_file']		=	'Dateien die nicht aufgenommen werden sollen. Die Seiten werden anhand der .txt Endung &uuml;berpr&uuml;ft (z.B. pages/sidebar.txt). Es muss der komplette Pfad aus dem Dateisystem angegeben werden. Sie m&uuml;ssen auch Regular Ausdr&uuml;cke verweden. Beispiel: /(start|mydir\/start.txt)/';
